    ...
    <div class="sidebar hide-scrollbar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/messageForms/global" class="nav-link <?php echo strpos(current_url(),'school/messageForms/global')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/exams/tables" class="nav-link <?php echo strpos(current_url(),'school/exams/tables')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/global/table" class="nav-link <?php echo strpos(current_url(),'school/global/table')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/gates/link" class="nav-link <?php echo strpos(current_url(),'school/gates/link')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/students/info" class="nav-link <?php echo strpos(current_url(),'school/students/info')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/teachers/info" class="nav-link <?php echo strpos(current_url(),'school/teachers/info')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/employees/info" class="nav-link <?php echo strpos(current_url(),'school/employees/info')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/subjects/info" class="nav-link <?php echo strpos(current_url(),'school/subjects/info')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/notifications/absence-tardiness" class="nav-link <?php echo strpos(current_url(),'school/notifications/absence-tardiness')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/notifications/public-messages" class="nav-link <?php echo strpos(current_url(),'school/notifications/public-messages')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/archive/absence-tardiness" class="nav-link <?php echo strpos(current_url(),'school/archive/absence-tardiness')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/archive/public-messages" class="nav-link <?php echo strpos(current_url(),'school/archive/public-messages')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/parents-responce/responce-archive" class="nav-link <?php echo strpos(current_url(),'school/parents-responce/responce-archive')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/support/technical/tickets/sys-managers" class="nav-link <?php echo strpos(current_url(),'school/support/technical/tickets/sys-managers')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/support/technical/tickets/parents" class="nav-link <?php echo strpos(current_url(),'school/support/technical/tickets/parents')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/services/questionnaires" class="nav-link <?php echo strpos(current_url(),'school/services/questionnaires')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/services/forms" class="nav-link <?php echo strpos(current_url(),'school/services/forms')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/partners/offers" class="nav-link <?php echo strpos(current_url(),'school/partners/offers')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?php echo base_url() . '/public/'; ?>school/partners/support" class="nav-link <?php echo strpos(current_url(),'school/partners/support')? 'active' :''; ?>">
