...
<div class="modal fade" id="add-employees-from-file" tabindex="-1" aria-labelledby="add-employees-from-fileLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable " role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="add-employees-from-fileLabel">اضافة موظفين من ملف</h5>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="" style="margin-left: auto;">
                ...
                <div class="mx-1">
                    <button type="button" class="btn btn-light" data-toggle="modal" data-target="#add-employees-from-file">تحميل ملف</button>
                </div>
            </div>
...
<script>
    ...
    function addFromFile(data) {
        ...
        var jqxhr = $.ajax({
                url: "<?= site_url('EmployeeExtends/AddEmployeesFromFile') ?>",
                method: "POST",
                timeout: 0,
                "processData": false,
