    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="add-temblateLabel">اضف معلم</h5>
                    ...
                    <div class="row">
                        <div class="col-md">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="teacher_num" id="teacher_num">
                            </div>
                        </div>
                        <div class="col-md">
                            <div class="form-group">
        ...
        <div class="card">
            <div class="card-header p-2 d-flex align-items-center bg-white">
                <div class="m-left-auto">
                    <button type="button" class="btn btn-light" data-toggle="modal" data-target="#add-temblate">اضف معلم</button>
                </div>
            </div>
