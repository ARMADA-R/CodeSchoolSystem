    ...
    <div class="sidebar hide-scrollbar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="<?= site_url() ?>partner/offers" class="nav-link <?php echo strpos(current_url(),'partner/offers')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?= site_url() ?>partner/support/technical/sys-managers/messaging" class="nav-link <?php echo strpos(current_url(),'partner/support/technical/sys-managers/messaging')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?= site_url() ?>partner/support/technical/parents/messaging" class="nav-link <?php echo strpos(current_url(),'partner/support/technical/parents/messaging')? 'active' :''; ?>">
                ...
                <li class="nav-item">
                    <a href="<?= site_url() ?>partner/support/technical/schools/messaging" class="nav-link <?php echo strpos(current_url(),'partner/support/technical/schools/messaging')? 'active' :''; ?>">
