...
<div class="row mt-4  mb-4  d-flex justify-content-center" style="font-size: 1rem;">
    ...
    <div class="col-4">
        <div class="form-group">
            <input type="text" id="ticket_name" class="form-control  determenators" placeholder="الاسم">
        </div>
    </div>
</div>
<!-- /.row -->
...
<script>
    ...
    function getTicketsData() {
        var jqxhr = $.ajax({
                url: "https://sa.arsail.net/schools/Tickets/GetPartnersAdminTicketsBypartnerId",
                method: "GET",
                timeout: 0,
                data: {
    ...
    function addTicket() {
        ...
        $.ajax({
                "url": "https://sa.arsail.net/schools/Tickets/AddPartnerAdminTicket",
                "method": "POST",
                "timeout": 0,
                "headers": {
                    "Authorization": "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJUaGVfc2Nob29sIiwiYXVkIjoiVGhlX3Jld3IiLCJpYXQiOiIyMDIxLTAyLTIyIiwiZXhwIjoiMjAyMi0wMi0yMiIsImRhdGEiOiIyMyJ9.ZITmmvk9fnZXo8Bfy30vw8uYK2kGZeN_M8XFPErmr_w",
