...
class StudentsModel extends Model
{
    ...
    public function get_students($school_id, $limit, $page, $key, $class_id = null, $semester_id = null)
    {
        $page = ($page - 1) * $limit;
        ...
        if ($class_id != null) {
            $query   = $builder->where("class_id", $class_id);
        }

        if ($semester_id != null) {
            $query   = $builder->where("semestar_id", $semester_id);
        }
    ...
    public function get_students_count($school_id, $class_id = null, $semester_id = null)
    {
